...
import matches from "./alphacards.json";
...
class App extends Component {
  ...
  // Setting this.state.matches to the alpha json array
  ...
  if (clickedMatch[0].clicked){
    ...
    console.log ("Best Score: " + bestScore);
        correctGuesses = 0;
        clickMessage = "Yikes! You've already selected this letter"
    ...
    for (let i = 0 ; i < matches.length ; i++){
      matches[i].clicked = false;
        ...
        correctGuesses++;
        clickMessage = "Keep going, You haven't clicked on that letter yet";
